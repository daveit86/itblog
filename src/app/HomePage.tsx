        ...
        <div className="mb-12">
          <div className="relative max-w-xl mx-auto">
            ...
            <input
              ...
              className="block w-full pl-14 pr-4 py-3 bg-card border border-border rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            />
            {searchQuery && (
              <button
